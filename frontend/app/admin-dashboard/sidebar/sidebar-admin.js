...
export default function AdminSidebar() {
  ...
  const menuItems = [
    ...
    { href: "/admin-dashboard/reports", icon: <FaClipboardList />, label: "All Reports" },
       { href: "/admin-dashboard/users", icon: <FaClipboardList />, label: "Users Management" },
      { href: "/admin-dashboard/stations", icon: <FaClipboardList />, label: "Stations" },
  ];
